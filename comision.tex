...
\begin{document}
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|c|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}
			...
			En grado décimo A contamos con varias perdidas entre ellas, 8 estudiantes pierden la asignatura de Research.
			
			El estudiante Samuel Quintero pierde español y Research, y Lorieth Chavarro pierde Física y Research& 
